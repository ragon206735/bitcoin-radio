  ...
  if (props.ipfs_cid) {
    return (
      <div
        ...
        className='bg-orange-400 drop-shadow-lg w-100 h-[35px] shadow-black rounded text-sm text-white flex justify-center items-center font-semibold cursor-pointer hover:drop-shadow-2xl transition-all ease-out'
      >
        {props.blockNumber}
        <FaRegPlayCircle
