...
const Inscribe = () => {
  ...
  return (
    <div className='py-24'>
      <div className='relative w-full inscribeContent'>
        <div className='py-4 text-4xl text-center text-gray-800'>
          ...
          <div className='grid grid-cols-1 lg:gap-6 gap:2'>
            <div>
              {!blockData.length ? (
                ...
                <>
                  <div className='grid grid-cols-6 gap-1 py-4 lg:grid-cols-10'>
                    <>
                  ...
                  <div className='flex items-center justify-center w-full col-span-8'>
                    <RangeSlider
                      min={0}
          ...
          <button className={styles.inscribeButton} onClick={calculatePrice}>
            {loading.uploading || loading.calculating ? (
              <span className='flex items-center h-full'>
                <Spinner className='mt-1 mr-2' size='sm' color='white' />
                Pleae wait...
              </span>
            ) : (
              <>
